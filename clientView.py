...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1070, 680)
        Form.setMinimumSize(QtCore.QSize(1070, 680))
        Form.setMaximumSize(QtCore.QSize(1070, 680))
        self.gvBoard = QtWidgets.QGraphicsView(Form)
        self.gvBoard.setEnabled(False)
        self.gvBoard.setGeometry(QtCore.QRect(5, 5, 700, 540))
        ...
        self.pbClear.setGeometry(QtCore.QRect(295, 560, 120, 40))
        self.pbClear.setObjectName("pbClear")
        self.lbConnectionImage = QtWidgets.QLabel(Form)
        self.lbConnectionImage.setGeometry(QtCore.QRect(565, 598, 20, 40))
        font = QtGui.QFont()
        ...
        self.lbConnectionStatus.setGeometry(QtCore.QRect(590, 610, 91, 16))
        self.lbConnectionStatus.setObjectName("lbConnectionStatus")
        self.pbGetColor = QtWidgets.QPushButton(Form)
        self.pbGetColor.setGeometry(QtCore.QRect(180, 570, 27, 27))
        ...
        self.leSendAnswer.setGeometry(QtCore.QRect(715, 190, 241, 30))
        ...
        self.lbSecretWord.setGeometry(QtCore.QRect(720, 70, 350, 21))
        self.lbSecretWord.setText("")
        self.lbSecretWord.setObjectName("lbSecretWord")
        self.pbStartGame = QtWidgets.QPushButton(Form)
        self.pbStartGame.setGeometry(QtCore.QRect(260, 560, 191, 41))
